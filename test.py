...
training_prep.save("C:/Users/cknie/Desktop/convertedMocapData/combined.npz")
...
for file in eval_files:
    ...
    ff_wrapper.save_prediction(file + "_FF")
#VAE
...
for file in eval_files:
    ...
    vae_wrapper.save_prediction(file + "_VAE")
#RNN
...
for file in eval_files:
    ...
    rnn_wrapper.save_prediction(file + "_RNN")
#GLOW
...
for file in eval_files:
    ...
    glow_wrapper.save_prediction(file + "_GLOW")
